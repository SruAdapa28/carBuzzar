package com.carbazzar.dealerservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public <T> ResponseDto<T> handleInternalServerException(HttpServerErrorException.InternalServerError e) {
        ...
        return ResponseDto.failure(e.getMessage() + " : " + e.getCause().toString(), HttpStatus.INTERNAL_SERVER_ERROR.toString(), HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
